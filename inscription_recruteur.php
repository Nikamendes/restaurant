...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "INSERT INTO restaurant_recruteurs (nom_utilisateur, mot_de_passe, nom, prenom, nom_entreprise, adresse_entreprise) 
    ...
    // Gérer les exceptions éventuelles qui pourraient survenir lors de l'exécution du code
