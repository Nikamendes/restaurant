...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $email = htmlspecialchars($_POST['email']); // Ajout de la variable email
        ...
        $sql = "INSERT INTO restaurant_candidats (Nom, Prenom, email, Experience, Adresse, Disponibilite, CV, mot_de_passe, Annonce) 
                VALUES (:nom, :prenom, :email, :experience, :adresse, :disponibilite, :cv, :mot_de_passe, :annonce)";
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(':nom', $nom, PDO::PARAM_STR);
        $stmt->bindParam(':prenom', $prenom, PDO::PARAM_STR);
        $stmt->bindParam(':email', $email, PDO::PARAM_STR); // Ajout de la variable email
...
<body>
    ...
    <form action="" method="POST">
        ...
        <div>
            ...
            <input type="email" id="email" name="email" required> <!-- Ajout du champ email -->
        </div>
        <div>
        ...
        <div>
            ...
            <textarea id="annonce" name="annonce" required></textarea> <!-- Ajout du champ annonce -->
        </div>
        <div>
